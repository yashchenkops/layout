        ...
        (_.render = function (t, e, i) {
          ...
          for (
            this._lazy !== !1 && (this._lazy = !1),
              ...
              0 === m &&
                (2 === this._initted && t > 0 && this._init(), this._startAt && (t >= 0 ? this._startAt.render(t, e, i) : r || (r = "_dummyGS")), this.vars.onStart && (0 !== this._totalTime || 0 === g) && (e || this._callback("onStart"))),
              n = this._firstPT;
            n;
            ...
            if (((f.svg = !(!t.getBBox || !Fe(t))), f.svg && (ze(t, Q(t, Se, r, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")), (we = a.useSVGTransformAttr || Me)), (o = Ee(t)), o !== Ie)) {
              if (16 === o.length) {
                ...
                f.zOrigin && ((L = -f.zOrigin), (E = M * L - o[12]), (N = z * L - o[13]), (L = I * L + f.zOrigin - o[14])),
                  (f.rotationX = B * F),
                  B &&
                    ((w = Math.cos(-B)), (b = Math.sin(-B)), (y = O * w + M * b), (T = A * w + z * b), (x = C * w + I * b), (M = O * -b + M * w), (z = A * -b + z * w), (I = C * -b + I * w), (X = D * -b + X * w), (O = y), (A = T), (C = x)),
                  (B = Math.atan2(M, I)),
                  (f.rotationY = B * F),
        ...
        (h._addLazySet = function (t, e, i) {
          ...
          (h._kill = function (e) {
            ...
            return (
              e.className &&
                (i = this._classNamePT) &&
                ((r = i.xfirst), r && r._prev ? this._linkCSSP(r._prev, i._next, r._prev._prev) : r === this._firstPT && (this._firstPT = i._next), i._next && this._linkCSSP(i._next, i._next._next, r._prev), (this._classNamePT = null)),
          ...
          for (t = n[a], i = r._firstPT; i; )
            (s = i._next),
              i.pg
                ? i.t._roundProps(o, !0)
                : i.n === t &&
                  (2 === i.f && i.t ? e(i.t._firstPT) : (this._add(i.t, t, i.s, i.c), s && (s._prev = i._prev), i._prev ? (i._prev._next = s) : r._firstPT === i && (r._firstPT = s), (i._next = i._prev = null), (r._propLookup[t] = l))),
              (i = s);
        return !1;
      }),
